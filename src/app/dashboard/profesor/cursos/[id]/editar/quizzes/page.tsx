/**
 * Página de quizzes del curso (profesor):
 * - Verifica que el profesor sea dueño del curso.
 * - Muestra el constructor de quizzes del curso.
 */
...
export default function EditarQuizzesCursoPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error("Error cargando quizzes del curso:", err);
        toast.error("No se pudo cargar el curso");
      } finally {
        setLoading(false);
      }
        ...
        <div className="editar-curso-view-layout">
          <section className="editar-curso-card editar-curso-view-header">
            <div className="editar-curso-card-content editar-curso-view-row">
              ...
              <div className="editar-curso-view-icon quiz" aria-hidden="true">
                <ClipboardCheck size={34} strokeWidth={2.35} />
              </div>
            </div>
          </section>
