/**
 * Editor exclusivo para profesores con Cuerpo.png y expresiones propias.
 *
 * Cuerpo.png funciona únicamente como estado inicial de una cuenta sin
 * configuración V2 previa. Dentro del editor siempre existe una prenda
 * seleccionada; al haber ropa, Cuerpo.png deja de renderizarse.
 */
"use client";
...
import {
  obtenerAccesoriosProfesorPersonalizado,
...
export default function ModalEditorAvatarProfesor({
  open,
  onClose,
  initialConfig,
  onSave,
  ...
  const modal = (
    <div
      ...
      style={{
        ...
        pointerEvents: avatarListo ? "auto" : "none",
